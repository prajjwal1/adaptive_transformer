...
class VCR(Dataset):
    def __init__(self, VCR_IMAGES_DIR, VCR_ANNOTS_DIR,split, mode, only_use_relevant_dets=True, add_image_as_a_box=True, embs_to_load='bert_da',
        ...
        self.h5fn = os.path.join(self.VCR_ANNOTS_DIR, f'{self.embs_to_load}_{self.mode}_{self.split}.h5')
    ...
    def __getitem__(self, index):
        ...
        image = load_image(os.path.join(self.VCR_IMAGES_DIR, item['img_fn']))
        ...
        ###################################################################
        # Load boxes.
        with open(os.path.join(self.VCR_IMAGES_DIR, item['metadata_fn']), 'r') as f:
