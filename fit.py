...
parser.add_argument(
        "--load_model", 
         type=str, 
         default=None, help='Load the model (usually the fine-tuned model.'
    )
parser.add_argument(
        "--test",
        action="store_true",
...
data_tuple_dict = {'train_tuple': train_tuple, 'valid_tuple': valid_tuple, 'test_tuple': test_tuple}
config = {'adaptive_enable': args.adaptive, 'sparse_enable': args.sparse, 'measure_flops': False, 
